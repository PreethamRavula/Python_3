...
#Challenge-2: Using the Superclass
class Robot:
    all_disabled = False
    latitude = -999999
    longitude = -999999
...
robot_walk.adjust_sensor(new_sensor_range = 20)
print(robot_walk.sensor_range)
print(robot_walk.obstacle_found)
print(robot_walk.step_length)

#Challenge-3: Conditional Superclass logic
class Robot:
    all_disabled = False
    latitude = -999999
    longitude = -999999
...
#Challenge-4: Overriding Dunder Methods
class Robot:
    all_disabled = False
    latitude = -999999
    longitude = -999999
...
#Challenge-5: Prevent a Robot takeover
class Robot:
    all_disabled = False
    latitude = -999999
    longitude = -999999
...
class WalkBot(Robot):
    ...
    def __init__(self, steps_per_minute = 0, direction = 180, sensor_range = 10, step_length = 5):
        super().__init__(steps_per_minute, direction, sensor_range)
        self.step_length = step_length
        WalkBot.no_of_walkbots += 1
        if Robot.robot_count >= 10 and WalkBot.no_of_walkbots >= 5:
